...
#-------------------------------------------------------------------------------------
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Details Added Sucessfully",parent=self.root)
                    self.show()
    ...
    def update(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                messagebox.showerror("Rrror","Invoice No. must be entered",parent=self.root)
            else:
                cur.execute("Select * from supplier where invoice=?",(self.var_sup_invoice.get(),))
                row=cur.fetchone()
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Details Updated Sucessfully",parent=self.root)
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error",f'Error due to: {str(ex)}',parent=self.root)
